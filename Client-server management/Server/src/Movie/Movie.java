...
public class Movie implements Serializable {
    ...
    public String getStrMovie() {
        String totalBoxOffice;
        if (this.getTotalBoxOffice() == null) totalBoxOffice = ""; else totalBoxOffice = this.getTotalBoxOffice().toString();
        String genre;
        if (this.getGenre() == null) genre = ""; else genre = this.getGenre().toString();
        String nationality;
        if (this.director.getNationality() == null) nationality = ""; else nationality = this.director.getNationality().toString();
