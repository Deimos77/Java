    ...
    public static void decodeFromCSV(String fileName) {
        ...
        try {
            for (int i = 0; i < line.length; i++) {
                ...
                if (elements[6].equals("") || elements[6].equals("null") || elements[6].equals("отсутствует")) {movie.setTotalBoxOffice(null); } else {
                ...
                if (elements[8].equals("") || elements[8].equals("null") || elements[8].equals("отсутствует")) {movie.setGenre(null); } else {movie.setGenre(Movie.MovieGenre.valueOf(elements[8])); }
                ...
                try {
                    if (elements[13].equals("") || elements[13].equals("null") || elements[13].equals("отсутствует")) {
...
//e.printStackTrace();
            System.out.println("Ошибка формата ввода, созданная коллекция будет пустой");
        } catch (Exception e) {
//e.printStackTrace();
            System.out.println("Коллекция не получила на ввод элементов, созданная коллекция будет пустой");
        }
    }
