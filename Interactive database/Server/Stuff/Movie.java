...
public class Movie implements Comparable, Serializable {
    ...
    public String getStrBeautyMovie() {
        ...
        String nationality;
        if (this.person.getNationality() == null) nationality = "отсутствует"; else nationality = this.person.getNationality().toString();
        return "Фильм[id: [" + this.getId() + "]]:" + "\n\t" +
                ...
                "Жанр: " + genre + ";\n\t" +
                "Режиссёр:" +
                "\n\t\tИмя режиссёра: " + this.person.getName() + ";\n\t\t" +
                "Рост: " + this.person.getHeight() + ";\n\t\t" +
                "Цвет глаз: "+ this.person.getEyeColor() + ";\n\t\t" +
